const projects = [
    {
        name: "FindMovies",
        description: {
            pt: "Trata-se de uma plataforma de filmes que permite aos usuários descobrir, pesquisar e visualizar detalhes completos sobre produções cinematográficas e séries. A aplicação oferece recursos de busca por título, filtros personalizados e exibição de informações como elenco, sinopse e avaliações, proporcionando uma experiência interativa e prática para quem deseja explorar o mundo do cinema.",
            en: "This is a movie platform that allows users to discover, search and view complete details about movies and TV shows. The application offers features such as title search, personalized filters and display of information like cast, synopsis and ratings, providing an interactive and practical experience for those who want to explore the world of cinema."
        } ,
        languages: [
            { name: "devicon-react-original colored fs-5" },
            { name: "devicon-html5-plain colored fs-5" },
    ...
    },
    {
        ...
        languages: [
            ...
            { name: "devicon-html5-plain colored fs-5" },
            { name: "devicon-css3-plain colored fs-5" },
            { name: "devicon-bootstrap-plain colored fs-5" },
            { name: "devicon-javascript-plain colored fs-5" },
            { name: "devicon-nodejs-plain-wordmark colored" },
            { name: "devicon-postgresql-plain colored fs-5" },
        ],
    ...
    },
    {
        ...
        languages: [
            ...
            { name: "devicon-bootstrap-plain colored fs-5" },
            { name: "devicon-javascript-plain colored fs-5" },
            { name: "devicon-nodejs-plain-wordmark colored fs-5" }, 
            { name: "devicon-postgresql-plain colored fs-5" },
        ],
    ...
    },
    {
        ...
        languages: [
            { name: "devicon-react-original colored fs-5" },
            { name: "devicon-html5-plain colored fs-5" },
            { name: "devicon-tailwindcss-original colored fs-5" },
            { name: "devicon-javascript-plain colored fs-5" },
        ],
